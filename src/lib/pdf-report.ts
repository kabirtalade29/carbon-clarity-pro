...
export function buildGwpOdpReport(data: MultiGwpOdpReportData): jsPDF {
  ...
  const drawFooter = () => {
    ...
    doc.setFontSize(8);
    doc.setFont("helvetica", "normal");
    doc.text("Generated by Climateintel.ai. Verified calculations aligned with Kigali Amendment & Montreal Protocol.", 48, 815);
...
export async function downloadGwpOdpReport(data: MultiGwpOdpReportData) {
  ...
  triggerPdfDownload(doc, `climateintel-gwp-odp-${data.id.slice(0, 8)}.pdf`);
}
