...
export function buildReport(data: ReportData): jsPDF {
  ...
  doc.setFontSize(8);
  doc.text(
    "Generated by Carbonly. This report is for informational purposes; verify against IPCC/GHG Protocol before disclosure.",
    48,
    815,
  );
...
export function buildConsolidatedReport(data: ConsolidatedReportData): jsPDF {
  ...
  const drawFooter = () => {
    ...
    doc.setFont("helvetica", "normal");
    doc.text(
      "Generated by Carbonly. Verified calculations aligned with GHG Protocol guidelines.",
      48,
      815,
    );
...
export function buildGwpOdpReport(data: GwpOdpReportData): jsPDF {
  ...
  if (data.notes) {
    if (y > 700) {
      ...
      doc.setFontSize(8);
      doc.text(
        "Generated by Carbonly. Verified calculations aligned with Kigali Amendment.",
        48,
        815,
      );
      doc.text(`Page ${pageNum}`, 547, 815, { align: "right" });
  ...
  doc.setFontSize(8);
  doc.setFont("helvetica", "normal");
  doc.text("Generated by Carbonly. Verified calculations aligned with Kigali Amendment.", 48, 815);
  doc.text(`Page ${pageNum}`, 547, 815, { align: "right" });
