...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      { title: "Sign in — clisomumbai" },
      {
        name: "description",
        content: "Sign in to your clisomumbai account with Google OAuth.",
      },
    ],
  }),
  component: AuthPage,
...
function AuthPage() {
  ...
  function handleGoogleSignIn() {
    // Redirect to the server auth endpoint
    ...
    <div className="grid min-h-screen md:grid-cols-2">
      ...
      <div className="relative hidden bg-primary text-primary-foreground md:flex md:flex-col md:justify-between md:p-12">
        ...
        <Link to="/auth" className="relative flex items-center gap-2">
          ...
          <span className="font-display text-xl tracking-tight">clisomumbai</span>
        </Link>
        <div className="relative">
          ...
          <p className="mt-4 text-sm text-primary-foreground/70">
            Climate Social Mumbai · Enterprise Decarbonization Platform
          </p>
        </div>
      ...
      <div className="flex flex-col items-center justify-center px-6 py-12 md:px-16">
        ...
        <div className="mb-8 flex items-center gap-2 md:hidden">
          ...
          <span className="font-display text-xl">clisomumbai</span>
        </div>
        ...
        >
          <Card className="rounded-2xl border-border/60 p-8">
            <div className="mb-8 text-center">
              ...
              <h1 className="font-display text-3xl">Welcome to clisomumbai</h1>
              <p className="mt-2 text-sm text-muted-foreground">
                Climate Social Mumbai enterprise carbon accounting & analytics.
              </p>
            </div>

            <div className="space-y-3">
              <Button size="lg" className="w-full gap-3 text-base" onClick={handleGoogleSignIn}>
          ...
          <p className="mt-6 text-center text-xs text-muted-foreground">
            By signing in, you agree to Climate Social Mumbai's terms of service and privacy policy.
          </p>
        </motion.div>
      </div>
    </div>
