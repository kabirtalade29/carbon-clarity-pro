...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Sign in to your Climateintel.ai account with Google OAuth.",
      },
    ],
  }),
  component: AuthPage,
        ...
        >
          <Card className="rounded-2xl border-border/60 p-8">
            <div className="mb-8 text-center">
              ...
              <h1 className="font-display text-3xl">Welcome to Climateintel.ai</h1>
              <p className="mt-2 text-sm text-muted-foreground">
                Sign in with Google OAuth or access instant demo workspace.
              </p>
            </div>
          ...
          <p className="mt-6 text-center text-xs text-muted-foreground">
            By signing in, you agree to Climateintel.ai's terms of service and privacy policy.
          </p>
        </motion.div>
      </div>
    </div>
